...
pub struct AppState {
    ...
    // ── Agent HQ extensions ─────────────────────────────────────
    /// Mission runner for autonomous multi-step tasks
    pub mission_runner: Option<Arc<crate::missions::MissionRunner>>,
    /// Plugin lifecycle manager
    pub plugin_manager: Option<Arc<crate::plugins::PluginLifecycleManager>>,
    /// Session store for chat session management
    pub session_store: Option<Arc<Mutex<crate::sessions::SessionStore>>>,
    /// Browser extension bridge
    pub browser_bridge: Option<Arc<crate::browser_bridge::BrowserBridge>>,
}
...
pub async fn run_gateway(host: &str, port: u16, config: Config) -> Result<()> {
    ...
    let state = AppState {
        ...
        shutdown_tx,
        // Agent HQ extensions
        mission_runner: Some(Arc::new(crate::missions::MissionRunner::new())),
        plugin_manager: {
