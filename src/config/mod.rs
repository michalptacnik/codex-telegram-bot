...
pub use schema::{
    ...
    ModelPricing, ModelRouteConfig, MultimodalConfig, NextcloudTalkConfig, ObservabilityConfig,
    OpenAiTtsConfig, OtpConfig, OtpMethod, PeripheralBoardConfig, PeripheralsConfig,
    PlannerExecutionConfig, ProxyConfig, ProxyScope, QdrantConfig, QueryClassificationConfig,
    ...
    StreamMode, TelegramConfig, TranscriptionConfig, TtsConfig, TunnelConfig, WebFetchConfig,
