...
/// Agent HQ — Powered by ZeroClaw engine. Zero overhead. Zero compromise. 100% Rust.
#[derive(Parser, Debug)]
#[command(name = "agent-hq")]
#[command(author = "theonlyhennygod, michalptacnik")]
#[command(version)]
#[command(about = "Agent HQ — The fastest, smallest AI assistant & Telegram bot.", long_about = None)]
struct Cli {
